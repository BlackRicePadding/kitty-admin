...
public class ResearchPeople {
	...
	public String getRemarksFive() {
		return remarksFive;
	}

	public void setRemarksFive(String remarksFive) {
		this.remarksFive = remarksFive;
	}

	public String getRemarksSix() {
		return remarksSix;
	}

	public void setRemarksSix(String remarksSix) {
		this.remarksSix = remarksSix;
	}

	public String getRemarksSeven() {
		return remarksSeven;
	}

	public void setRemarksSeven(String remarksSeven) {
		this.remarksSeven = remarksSeven;
	}
